...
#code by xty 2023.4.4
#----------------------------------------只需要修改以下部分-----------------------------------------------------------#
# xml文件存放目录
input_dir = r'C:/Users/xty/Desktop/goosedata/duck/xmls'  #你放xml文件夹的文件夹（不要以\结尾）

# 输出txt文件目录
out_dir = r'C:/Users/xty/Desktop/goosedata/duck/labels'  #你放txt文件夹的文件夹（不要以\结尾）
#----------------------------------------只需要修改以上部分-----------------------------------------------------------#
class_list = []
