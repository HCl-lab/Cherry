...
configurations = {
    'cfg': dict(
        ...
        load_from=r"F:\Torch_Classify-master\torch_classify_weights\vovnet_weights\vovnet_weights\vovnet39_torchvision.pth",             # pretrain weight of imagenet
        resume=False,
        ...
        augment='imagenet',          # ['simple', 'ra', 'tawide', 'imagenet', 'cifar10', 'svhn']
        img_size=[128,128],       # efficientnetv1 b0:224, b1:240, b2:260, b3:300, b4:380, b5:456, b6:528, b7:600, xception 299
        val_resize=[128,128],
